...
DEMO_MODELS = [
    dict(
        ...
        license="llama3.1",
        ctx=131072,
        # Llama-3.1-Instruct supports tool calling and is a general reasoning model.
    ...
    dict(
        ...
        license="apache-2.0",
        ctx=131072,
        # Qwen2.5-Instruct supports function calling.
        caps=["text", "reasoning", "tools"],
    ...
    dict(
        ...
        license="apache-2.0",
        ctx=32768,
        # VL models reason over images+text; no tool-calling in the base release.
        caps=["text", "reasoning", "vision"],
    ...
    dict(
        ...
        license="gemma",
        ctx=8192,
        # Gemma-2-it does not advertise function/tool calling.
        caps=["text", "reasoning"],
